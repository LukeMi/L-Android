...
public class TorchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_torch);
    ...
    private void initView() {
        ...
        torchSwitch = ((Button) findViewById(com.lukemi.myandroid.R.id.torchSwitch));
        adjustBright = ((Button) findViewById(com.lukemi.myandroid.R.id.torchSwitch));
    ...
    public void onClick(View v) {
        ...
        try {
            switch (v.getId()) {
                case com.lukemi.myandroid.R.id.torchSwitch:
                    ...
                    break;
                case com.lukemi.myandroid.R.id.adjustBright:
                    if (smoothValue >= 0) {
