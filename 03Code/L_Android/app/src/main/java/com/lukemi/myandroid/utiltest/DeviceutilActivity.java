...
public class DeviceutilActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_deviceutil);
        initView();
        setDeviceInfoToTV();
    }
    ...
    private void initView() {
        refreshBTN = ((Button) findViewById(com.lukemi.myandroid.R.id.refreshBTN_DUAct));
        refreshBTN.setOnClickListener(this);
        showDeviceInfoTV = ((TextView) findViewById(com.lukemi.myandroid.R.id.showDeviceInfo_DUAct));
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case com.lukemi.myandroid.R.id.refreshBTN_DUAct:
                setDeviceInfoToTV();
                break;
        }
    }
