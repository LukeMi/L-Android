...
public class DialogUtilActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.tutorial.R.layout.activity_dialog_util);
        initView();
    }

    private void initView() {
        findViewById(com.lukemi.android.tutorial.R.id.show_progressDialog).setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.android.tutorial.R.id.show_progressDialog:
