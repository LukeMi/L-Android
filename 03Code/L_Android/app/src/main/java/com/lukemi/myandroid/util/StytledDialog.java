/*
package com.tbug.android.collection.util;
...
/**
    ...
    private static int assignListDialogView(final Context context, View root ,final Dialog dialog, final List<String> words, final MyItemDialogListener listener) {
...
// 设置显示位置
    ...
    public abstract interface MyItemDialogListener {
