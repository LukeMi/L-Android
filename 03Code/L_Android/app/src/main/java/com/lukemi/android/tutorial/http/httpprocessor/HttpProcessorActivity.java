...
public class HttpProcessorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.tutorial.R.layout.activity_http_processor);
        textView = ((TextView) findViewById(com.lukemi.android.tutorial.R.id.shoeTV));
        findViewById(com.lukemi.android.tutorial.R.id.btn).setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.android.tutorial.R.id.btn:
                excuteHttp();
                break;
            default:
                break;
