...
public class BitmapUtilActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        showIV = ((ImageView) findViewById(com.lukemi.myandroid.R.id.showIV));
...
//        showIV.setOnClickListener(this);
        ...
        findViewById( R.id.takeActivityShot).setOnClickListener(this);
        findViewById( R.id.takeViewShot).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.createReflectionImageWithOrigin:
                ...
                break;
            case R.id.takeActivityShot:
                showIV.setImageBitmap(BitmapUtils.takeActivityShot(this));
            case R.id.takeViewShot:
                showIV.setImageBitmap(BitmapUtils.takeViewShot(findViewById(R.id.activity_bitmap_util)));
                break;
        }
    }
}
