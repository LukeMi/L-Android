...
public class DetailPhotoFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NORMAL, com.lukemi.android.tutorial.R.style.Dialog_FullScreen);
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        imageView = (ImageView) inflater.inflate(com.lukemi.android.tutorial.R.layout.photodetail_view, container, true);
...
/*    @Override
    ...
    public void onClick(View v) {
        if (v.getId() == com.lukemi.android.tutorial.R.id.photoDetail) {
