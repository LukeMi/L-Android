package com.tbug.android.collection_demo.view;
...
public class ZoomImageView extends ImageView {
     ...
     *
     * @param context 上下文
     * @throws Exception 异常（ImageView设置Bitmap获取为null时候）
     */
    public ZoomImageView(Context context) throws Exception {
        super(context);
        initUI();
    }

    public ZoomImageView(Context context, AttributeSet attrs) throws Exception {
        super(context, attrs);
        initUI();
    }

    public ZoomImageView(Context context, AttributeSet attrs, int defStyle) throws Exception {
     ...
     * 获得图片内在宽高
     */
    private void getIntrinsicWidthHeight() throws Exception {
        ...
        if (drawable != null) {
            ...
            throw new RuntimeException("----ImageView 请设置setDrawingCacheEnabled(true)----");
        }
    }
