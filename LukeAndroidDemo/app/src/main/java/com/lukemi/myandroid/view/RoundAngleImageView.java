...
public class RoundAngleImageView extends ImageView {
    ...
    public RoundAngleImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            roundWidth = typedArray.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundWidth, roundWidth);
            roundHeight = typedArray.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundHeight, roundHeight);
            typedArray.recycle();
        } else {
