...
import com.lukemi.myandroid.util.ZipUtil;
...
public class ZipUtilActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_zip_util);
        initView();
    }
    ...
    private void initView() {
        zipStr_ZIPBTN = ((Button) findViewById(com.lukemi.myandroid.R.id.zipStr_ZIP));
        unZipStr_ZIPBTN = ((Button) findViewById(com.lukemi.myandroid.R.id.unZipStr_ZIP));
        zipStrET_ZIPET = ((EditText) findViewById(com.lukemi.myandroid.R.id.zipStrET_ZIP));
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case com.lukemi.myandroid.R.id.zipStr_ZIP:
                ...
                break;
            case com.lukemi.myandroid.R.id.unZipStr_ZIP:
                try {
