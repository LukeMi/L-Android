package com.lukemi.myandroid.weather;
...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_weather);
        initView();
        loadWeatherInfo("安庆");
    }
    ...
    private void initView() {
        cityName = ((TextView) findViewById(com.lukemi.myandroid.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.myandroid.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.myandroid.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.myandroid.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.myandroid.R.id.cityName));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.myandroid.R.id.cityName:
                break;
            case com.lukemi.myandroid.R.id.wrap_content:
                break;
        }
    }
