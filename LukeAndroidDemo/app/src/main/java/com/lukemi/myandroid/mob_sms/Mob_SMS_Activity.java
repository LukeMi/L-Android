package com.lukemi.myandroid.mob_sms;
...
public class Mob_SMS_Activity extends AppCompatActivity implements View.OnClickListener, Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_mob__sms);
        initSDK();
        initViews();
    }

    private void initViews() {
        defined_Code_ET = ((EditText) findViewById(com.lukemi.myandroid.R.id.defined_Code_ET));
        security_code_ET = ((EditText) findViewById(com.lukemi.myandroid.R.id.security_code_ET));
        sendRequestBTN = ((Button) findViewById(com.lukemi.myandroid.R.id.sendRequestBTN));
        submit_secrityCode = ((Button) findViewById(com.lukemi.myandroid.R.id.submit_secrityCode));
...
//                refreshViewCount(data);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.lukemi.myandroid.R.id.sendRequestBTN:
                //获取验证码
                int c = 0;
                break;
            case com.lukemi.myandroid.R.id.submit_secrityCode:
                //提交验证信息
//                registerUser("CN",  );
                break;
        }
