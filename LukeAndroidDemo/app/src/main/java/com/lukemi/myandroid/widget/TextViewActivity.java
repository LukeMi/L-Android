...
public class TextViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.myandroid.R.layout.activity_text_view);
        initView();
    }
    ...
    private void initView() {
        vitercal_Scroll = ((TextView) findViewById(com.lukemi.myandroid.R.id.vitercal_Scroll));
        horizontal_Scroll = ((TextView) findViewById(com.lukemi.myandroid.R.id.horizontal_Scroll));
        marqueeTextView = ((TextView) findViewById(com.lukemi.myandroid.R.id.marqueeTextView));
