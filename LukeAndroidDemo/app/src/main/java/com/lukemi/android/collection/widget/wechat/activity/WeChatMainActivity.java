...
import com.lukemi.android.collection.widget.wechat.fragment.WeChatContactFragment;
import com.lukemi.android.collection.widget.wechat.fragment.WeChatDiscoverFragment;
import com.lukemi.android.collection.widget.wechat.fragment.WeChatMSGFragment;
import com.lukemi.android.collection.widget.wechat.fragment.WeChatMineFragment;
...
public class WeChatMainActivity extends AppCompatActivity {
    ...
    private int[] drawableIDs = new int[]{com.lukemi.android.collection.R.drawable.selector_wechat_main_message
            , com.lukemi.android.collection.R.drawable.selector_wechat_main_contact
            , com.lukemi.android.collection.R.drawable.selector_wechat_main_discover
            , com.lukemi.android.collection.R.drawable.selector_wechat_main_mine};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.lukemi.android.collection.R.layout.activity_we_chat_main);
        initView();
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.lukemi.android.collection.R.menu.menu_wechat_main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.lukemi.android.collection.R.id.action_search:
                Toast.makeText(this, "R.id.action_search", Toast.LENGTH_SHORT).show();
                break;
            case com.lukemi.android.collection.R.id.action_group_chat:
                Toast.makeText(this, "R.id.action_group_chat", Toast.LENGTH_SHORT).show();
                break;
            case com.lukemi.android.collection.R.id.action_add_friend:
                Toast.makeText(this, "R.id.action_add_friend", Toast.LENGTH_SHORT).show();
                break;
            case com.lukemi.android.collection.R.id.action_scan:
                Toast.makeText(this, "R.id.action_scan", Toast.LENGTH_SHORT).show();
                break;
            case com.lukemi.android.collection.R.id.action_feed:
    ...
    private void initView() {
        mainViewPager = ((ViewPager) findViewById(com.lukemi.android.collection.R.id.mainViewPager));
        navigateTabLayout = ((TabLayout) findViewById(com.lukemi.android.collection.R.id.bottomNavigationBar));
        initMainViewPager();
...
//方法一
    ...
    class MainAdapter extends FragmentPagerAdapter {
        ...
        public View getTabView(int position) {
            View view = View.inflate(context, com.lukemi.android.collection.R.layout.item_wechat_main_navigation, null);
            ImageView imageView = (ImageView) view.findViewById(com.lukemi.android.collection.R.id.icon);
            TextView textView = (TextView) view.findViewById(com.lukemi.android.collection.R.id.title);
