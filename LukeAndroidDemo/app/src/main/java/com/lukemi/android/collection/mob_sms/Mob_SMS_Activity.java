package com.lukemi.android.collection.mob_sms;
...
public class Mob_SMS_Activity extends AppCompatActivity implements View.OnClickListener, Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.collection.R.layout.activity_mob__sms);
        initSDK();
        initViews();
    }

    private void initViews() {
        defined_Code_ET = ((EditText) findViewById(com.lukemi.android.collection.R.id.defined_Code_ET));
        security_code_ET = ((EditText) findViewById(com.lukemi.android.collection.R.id.security_code_ET));
        sendRequestBTN = ((Button) findViewById(com.lukemi.android.collection.R.id.sendRequestBTN));
        submit_secrityCode = ((Button) findViewById(com.lukemi.android.collection.R.id.submit_secrityCode));
...
//                refreshViewCount(data);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.lukemi.android.collection.R.id.sendRequestBTN:
                //获取验证码
                int c = 0;
                break;
            case com.lukemi.android.collection.R.id.submit_secrityCode:
                //提交验证信息
//                registerUser("CN",  );
                break;
        }
