...
import com.lukemi.android.collection.widget.wechat.activity.WeChatLoginActivity;
...
public class EditTextActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.collection.R.layout.activity_edit_text);
        initVIew();
    }

    private void initVIew() {
        textPasswordET = ((EditText) findViewById(com.lukemi.android.collection.R.id.textPassword));
        weChatActivity = (Button) findViewById(com.lukemi.android.collection.R.id.weChatActivity);
        ic_password_deleteBTN = (Button) findViewById(com.lukemi.android.collection.R.id.ic_password_delete);
        ic_password_showBTN = (Button) findViewById(com.lukemi.android.collection.R.id.ic_password_show);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.android.collection.R.id.ic_password_delete:
                Logcat.log("EditTextActivity----> click---->> ic_password_delete");
                textPasswordET.setText("");
                break;
            case com.lukemi.android.collection.R.id.ic_password_show://设置密码是否可见
                ...
                break;
            case com.lukemi.android.collection.R.id.textPassword:
                //设置光标位置---防止点击之后游标回到0位置
                ...
                break;
            case com.lukemi.android.collection.R.id.weChatActivity:
