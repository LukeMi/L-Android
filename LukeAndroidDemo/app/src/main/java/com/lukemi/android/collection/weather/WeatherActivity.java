package com.lukemi.android.collection.weather;
...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.collection.R.layout.activity_weather);
        initView();
        loadWeatherInfo("安庆");
    }
    ...
    private void initView() {
        cityName = ((TextView) findViewById(com.lukemi.android.collection.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.android.collection.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.android.collection.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.android.collection.R.id.cityName));
        cityName = ((TextView) findViewById(com.lukemi.android.collection.R.id.cityName));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.android.collection.R.id.cityName:
                break;
            case com.lukemi.android.collection.R.id.wrap_content:
                break;
        }
    }
