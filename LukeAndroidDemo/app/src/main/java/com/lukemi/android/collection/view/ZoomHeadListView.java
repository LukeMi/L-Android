...
public class ZoomHeadListView extends ListView {
    ...
    public ZoomHeadListView(Context context) {
        super(context);
        defaultImageViewHeight = context.getResources().getDimensionPixelSize(com.lukemi.android.collection.R.dimen.defaultImageViewHeight);
    ...
    public ZoomHeadListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
