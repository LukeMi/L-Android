package com.lukemi.android.collection.baidu;
...
import com.lukemi.android.collection.util.BDLocationUtil;
...
public class BDLocActivity extends AppCompatActivity implements View.OnClickListener, BDLocationUtil.LocationCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.collection.R.layout.activity_baidu_loc);
        initViews();
    }
...
//        return super.onCreateOptionsMenu(menu);
    ...
    private void initViews() {
        ...
        content = ((TextView) findViewById(com.lukemi.android.collection.R.id.content));
        content.setMovementMethod(ScrollingMovementMethod.getInstance());
        findViewById(com.lukemi.android.collection.R.id.title).setBackgroundColor(getResources().getColor(com.lukemi.android.collection.R.color.transparent));
        findViewById(com.lukemi.android.collection.R.id.startLoc).setOnClickListener(this);
        findViewById(com.lukemi.android.collection.R.id.stopLoc).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.lukemi.android.collection.R.id.startLoc:
                showPDialog();
                bdLocationUtil.start();
                break;
            case com.lukemi.android.collection.R.id.stopLoc:
                bdLocationUtil.stop();
                break;
        }
    }
