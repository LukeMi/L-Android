...
public class ScaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lukemi.android.collection.R.layout.activity_scale);
        scaleImg = ((ImageView) findViewById(com.lukemi.android.collection.R.id.scale_img_ScaleAct));
